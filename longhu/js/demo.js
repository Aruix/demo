...
var	animEndEventNames = {
	...
	animEndEventName = animEndEventNames[ hasAnimate() ];
function NextPage(predemo,nextdemo,anim){
	var next = nextdemo,
		pre = predemo,
		outClass = '', 
		inClass = ''
